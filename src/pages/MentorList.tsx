...
const MentorList = () => {
  ...
  const expertiseOptions = ["all", ...Array.from(new Set(mentorData.map(m => m.expertise)))];
  ...
  const filteredAndSortedData = useMemo(() => {
    ...
    if (filterExpertise !== "all") {
      result = result.filter(mentor => mentor.expertise === filterExpertise);
    }
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Select value={sortBy} onValueChange={setSortBy}>
            ...
            <SelectContent>
              ...
              <SelectItem value="experience-high">Experience: Most to Least</SelectItem>
              <SelectItem value="experience-low">Experience: Least to Most</SelectItem>
            </SelectContent>
          </Select>
