                ...
                <section className="py-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    <div className="text-center p-6">
                        ...
                        <p className="text-muted-foreground">
                            Connect with businesses that need your specific
                            expertise, from supply chain to digital marketing.
                        </p>
                    </div>
                    <div className="text-center p-6">
                        <div className="flex justify-center mb-4">
                        ...
                        <p className="text-muted-foreground">
                            Earn meaningful equity stakes (10-25%) in businesses
                            you help grow and scale.
                        </p>
                    </div>
                    <div className="text-center p-6">
                        <div className="flex justify-center mb-4">
                        ...
                        <p className="text-muted-foreground">
                            Work with diverse UMKM sectors including F&B,
                            fashion, manufacturing, and beauty products.
                        </p>
                    </div>
                </section>
                        ...
                        <Link to="/umkm">
                            <div className="p-8 border border-border rounded-lg hover:shadow-lg transition-shadow cursor-pointer bg-card h-full">
                                ...
                                <p className="text-muted-foreground mb-4">
                                    Browse businesses seeking mentorship and
                                    support. Apply your expertise to help them
                                    overcome challenges and achieve their growth
                                    goals.
                                </p>
                                <div className="flex items-center gap-2 text-primary font-semibold">
                                    View UMKM Businesses{" "}
                        ...
                        <Link to="/mentors">
                            <div className="p-8 border border-border rounded-lg hover:shadow-lg transition-shadow cursor-pointer bg-card h-full">
                                ...
                                <p className="text-muted-foreground mb-4">
                                    ...
                                    specialize in various business domains. Get
                                    the strategic guidance you need to scale
                                    your business.
                                </p>
                                <div className="flex items-center gap-2 text-primary font-semibold">
